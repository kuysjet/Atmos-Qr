  ...
  <!-- /.content-header -->
    ...
    <div class="content">
      ...
      <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <table id="facultyTable" class="display table table-bordered nowrap" style="display: none; width:100%;">
                  <thead>
                  <tr>
                    <th>
...
$(document).ready(function() {
  ...
  var table = $('#facultyTable').DataTable({
    ...
    $('#facultyTable tfoot th').each(function(index) {
      if (index > 5 && index !== 8) { // Skip the first column and the ninth column (index 8)
          var title = $(this).text();
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="submit" class="btn btn-primary btn-sm" form="addFacultyForm"><i class="fas fa-paper-plane fa-sm"></i> Submit</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="editFacultyModal" tabindex="-1" role="dialog" aria-labelledby="editFacultyModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="submit" class="btn btn-primary btn-sm" form="editFacultyForm"><i class="fas fa-save fa-sm"></i> Save Changes</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="importFacultyCsvModal" tabindex="-1" role="dialog" aria-labelledby="importFacultyCsvModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="submit" class="btn btn-primary btn-sm" form="importFacultyCsvForm"><i class="fas fa-file-import fa-sm"></i> Import</button>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body text-center d-flex flex-column align-items-center justify-content-center" id="modalBodyToDownload">
        ...
        <div class="card" id="cardToDownload" style="width: 300px;">
          <img src="dist/img/Card-Faculty.png" class="card-img" alt="Background Image" style="width: 100%; height: auto;">
          <div class="card-img-overlay d-flex flex-column justify-content-center align-items-center" style="height: 100%;">
            ...
            <!-- Profile Image -->
            <img src="dist/img/no-avatar.jpg" class="rounded-circle" id="facultyProfile" alt="Profile Image" style="width: 140px; height: 140px; border: 3px solid #F833C3;">
            <!-- Faculty Name -->
            <div id="facultyName" class="font-weight-bold" style="font-size: 14px; font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; margin-top: 6px; color: black; display: inline-block; max-width: 70%;">Faculty Name</div>
            <!-- Faculty Position -->
            <div id="facultyPosition" class="font-weight-bold mb-2" style="font-size: 10px; color:#F833C3; font-family:'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif;">Position</div>
            <!-- QR Code Image -->
