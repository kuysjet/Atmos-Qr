  ...
  $('#importSeniorHighCsvForm').on('submit', function(e) {
    ...
    $('#seniorhighStudentsTable').on('click', '.edit-btn', function() {
      ...
      $('#editStrand').val(rowData['Strand']);
      $('#editGrade').val(rowData['Grade']);
      $('#editSection').val(rowData['Section']);
...
$('#seniorhighStudentsTable').on('click', '.view-qr-btn', function() {
  // Assuming that the IdentificationNumber is stored in a data attribute of the button
  var identificationNumber = $(this).attr('data-id'); // Adjust this if the attribute storing the ID differs

  // Update the path construction to use the identificationNumber
  var qrCodePath = 'qr_codes/' + identificationNumber + '.png';

  $('#qrCodeImage').attr('src', qrCodePath); // Set the src attribute of the image in the modal
  $('#viewQrCodeModal').modal('show'); // Show the modal
});
        ...
        <div class="modal-body">
          ...
          <div class="row">
            ...
            <div class="form-group">
              ...
              <option value="">Select Strand</option> <!-- Blank option -->
                  <?php
                  // Database connection code
                  include 'database/db.php';

                  // Query to fetch ENUM values of 'Strand' column from the 'SeniorHighStudents' table
                  $query = "SELECT COLUMN_TYPE FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'SeniorHighStudents' AND COLUMN_NAME = 'Strand'";
            ...
            <div class="form-group">
              ...
              <select class="form-control" id="grade" name="grade" required>
                  <option value="">Select Grade</option> <!-- Blank option -->
                  <?php
                  // Database connection code
                  include 'database/db.php';

                  // Query to fetch ENUM values of 'Grade' column from the 'SeniorHighStudents' table
                  $query = "SELECT COLUMN_TYPE FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'SeniorHighStudents' AND COLUMN_NAME = 'Grade'";
                  $result = mysqli_query($conn, $query);
            ...
            <div class="form-group">
              ...
              <select class="form-control" id="section" name="section" required>
                  <option value="">Select Section</option> <!-- Blank option -->
                  <?php
                  // Database connection code
                  include 'database/db.php';

                  // Query to fetch ENUM values of 'Section' column from the 'SeniorHighStudents' table
                  $query = "SELECT COLUMN_TYPE FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'SeniorHighStudents' AND COLUMN_NAME = 'Section'";
                  $result = mysqli_query($conn, $query);
      ...
      <div class="modal-body text-center">
        ...
        <div class="card" style="max-width: 50%; margin: auto;">
          ...
          <div class="card-img-overlay d-flex flex-column justify-content-center align-items-center">
            ...
            <!-- QR Code Image -->
            <img id="qrCodeImage" src="YOUR_QR_CODE_IMAGE_URL" alt="QR Code" style="max-width: 60%;">
          </div>
        </div>
      </div>
