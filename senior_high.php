...
// Submit form for adding new senior high student
    ...
    $.ajax({
        ...
        success: function(response) {
            if (response.status === 'success') {
                ...
                // Show specific error message if addition failed
                if (response.error === 'Duplicate identification number') {
                    Swal.fire("Error", "Identification number already exists", "error");
...
$('#seniorhighStudentsTable').on('click', '.view-qr-btn', function() {
  ...
  var strand = rowData['strand_name']; 
  var grade = rowData['grade_name']; 
  var section = rowData['section_name']; 
  ...
  // Display the student's strand, grade & section inside the card
  $('#studentSGS').text(strand + '-' + grade + '-' + section);
